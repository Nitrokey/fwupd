...
#define FU_WACOM_DEVICE_STATUS_REPORT_ID	0x04
#define FU_WACOM_DEVICE_STATUS_REPORT_SZ	16

#define FU_WACOM_DEVICE_FW_REPORT_ID		0x02
#define FU_WACOM_DEVICE_FW_CMD_QUERY_MODE	0x00	/* 0x00=rt, 0x02=bl */
#define FU_WACOM_DEVICE_FW_CMD_DETACH		0x02

#define FU_WACOM_DEVICE_FW_MAINTAIN_REPORT_ID	0x09
#define FU_WACOM_DEVICE_FW_MAINTAIN_REPORT_SZ	64

#define FU_WACOM_DEVICE_BL_REPORT_ID_SET	0x07
#define FU_WACOM_DEVICE_BL_REPORT_ID_GET	0x08
...
#define FU_WACOM_DEVICE_BL_CMD_ATTACH		0x03
...
#define FU_WACOM_DEVICE_RC_CHECKSUM1		0x81
#define FU_WACOM_DEVICE_RC_CHECKSUM2		0x82
